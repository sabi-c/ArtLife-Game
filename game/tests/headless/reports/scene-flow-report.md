...
| # | Label | Status | Notes |
|---|-------|--------|-------|
| 1 | IntroScene is active on boot | ✅ |  |
| 2 | Phaser canvas is visible with dimensions | ✅ |  |
| 3 | Terminal is hidden during IntroScene | ✅ |  |
| 4 | CharacterSelectScene activated after login flow | ✅ |  |
...
| 16 | "Visit Venue" or "Browse Market" in dashboard menu | ✅ |  |
| 17 | "Advance Week" in dashboard menu | ✅ |  |
| 18 | Terminal rendered content (2648 chars) | ✅ |  |
